...
if (isset($_POST['submit'])) {
    ...
    if ($Pan_Number != null) {
        ...
        if (!preg_match_all($regex, $Pan_Number)) {
            $Pan_Number_error = "Invalid Passport Number";
        } else {
            ...
            if (mysqli_num_rows($result) > 0) {
                $Pan_Number_error = "* Passport Number Already Exist";
            }
        }
    } else {
        $Pan_Number_error = "* Please Enter Passport Number";
    }
    ...
    if (!is_numeric($Adhar_Number) || is_null($Adhar_Number) || !preg_match('/^[0-9]{12}+$/', $Adhar_Number)) {
        $Adhar_Number_error = "invalid citizenship Number";
    } else {
        ...
        if (mysqli_num_rows($result1) > 0) {
            $Adhar_Number_error = "* Citizenship Number Already Exist";
        }
    }
    ...
    <form id="regForm" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="tab mb-3" id="KycTab">
            ...
            <div class="form-group mb-3">
                <label for="exampleFormControlFile1">Citizenship Card</label>
            ...
            <div class="form-groupmb-3">
                <label for="exampleFormControlFile1">Upload Passport Card</label>
