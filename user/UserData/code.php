...
// Send Otp on User Account for transaction

if(isset($_POST['TransactionOtp'])){


    $query = "SELECT C_Email FROM customer_detail WHERE Account_No = '$AcNo'";
...
if(isset($_POST['ValidateOtp'])){
    ...
    // echo $sessionOtp;
    if($sessionOtp == $_POST['ValidateOtp']){
        echo "done";
        unset($_SESSION['otp']);
    }
    else{
