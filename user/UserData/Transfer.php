...
if (isset($_POST['Verify'])){
    ...
    $Account_err= $Amount_err= "";
    if (empty(trim($_POST['AccountNo'])) && empty(trim($_POST['Amount']))) {
        header("Location: ../UserData/Transfer.php?error=AccountNo and Amount required");
        ...
        header("Location: ../UserData/Transfer.php?error=AccountNo required");
    
    } elseif (empty(trim($_POST['Amount']))) {
        $Account_err = "Please Enter Minimum 1 rupees";
        header("Location: ../UserData/Transfer.php?error=Amount required");
    

    }else{
        header ('Location: ../UserData/transfer_twostep.php');
        exit();
                                ...
                                <!-- Customer Account Number -->
                                        <div style="margin-left: 15%; margin-right: 15%; margin-top:10%;">
                                            <div class="input-group mt-5">
                                                ...
                                                <input type="text" id="AccountNo" name="AccountNo" class="form-control gray_bg light" aria-label="Default" placeholder="Enter Account No..." aria-describedby="inputGroup-sizing-default">
                                    ...
                                    <!-- Amount -->
                                        <div class="form-group">
                                            <div class="input-group mb-1 mt-5">
                                                ...
                                                <input id="Amount" type="tel" name="Amount" class="form-control gray_bg light" aria-label="Default" placeholder="Enter Amount..." aria-describedby="inputGroup-sizing-default">
                                        ...
                                        <div id="Pay" class="d-grid gap-2 mt- col-sm-5 mx-auto">

                                            <button type="button" style="margin-top: 20%; margin-bottom: 25%;" class="btn btn-pay btn-lg btn-block">Pay Money</button>
                                            <button type="submit" id ="Verify" style=" font-size : 17px; width: 275px; margin-top: 20%; margin-bottom: 25%;" class="btn btn-pay1 btn-lg  btn-block" name="Verify" >Verify From Google Authenticator</button>
