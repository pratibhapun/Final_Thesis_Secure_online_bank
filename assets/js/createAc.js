...
$(document).ready(function () {
    ...
    $('#AdharNo').blur(function () {
        ...
        if (AdharNo == "" || AdharNo.length > 12 || AdharNo.length < 12) {
            $('#AdharError').text('Invalid Citizenship Number');
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response != "0") {
                        $("#AdharError").text("Citizenship Number Already Exist!");
                        $("#nextBtn").attr('disabled', true);
                        AdharError = 1;
                    }
                    else {
    ...
    $('#PanNo').blur(function () {
        ...
        if (PanNo == "" || PanNo.length > 10 || PanNo.length < 10) {
            ...
            $('#PanError').text('Invalid Passport Number');
            $("#nextBtn").attr('disabled', true);
            PanError = 1;
        }
        else {
            ...
            if (!regex.test(PanNo)) {
                ...
                $('#PanError').text('Invalid Passport Number Format');
                $("#nextBtn").attr('disabled', true);
                PanError = 1;
            }
            else {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response != "0") {
                            $("#PanError").text("Passport Number Already Exist");
                            $("#nextBtn").attr('disabled', true);
                            PanError = 1;
                        }
                        else {
