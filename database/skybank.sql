...
CREATE TABLE `customer_detail` (
  ...
  `googlecode` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `customer_detail` (`C_No`, `Account_No`, `C_First_Name`, `C_Last_Name`, `Gender`, `C_Father_Name`, `C_Mother_Name`, `C_Birth_Date`, `C_Adhar_No`, `C_Pan_No`, `C_Mobile_No`, `C_Email`, `C_Pincode`, `C_Adhar_Doc`, `C_Pan_Doc`, `Create_Date`, `ProfileColor`, `ProfileImage`, `Bio`,`google_code`) VALUES
(1, '410211023120', 'Admin', 'Bhai', 'Male', 'Jarvis', 'Alexa', '2002-01-01', '123456789011', 'DBCDD1234C', '6622894805', 'admin@gmail.com', '123456', 'customer_data/Adhar_doc/admin.jpg', 'customer_data/Pan_doc/Pan04102021102312.jpg', '2021-03-15', 'Blue', 'customer_data/Profile_Img/Admin.jpg', '','12345'),
